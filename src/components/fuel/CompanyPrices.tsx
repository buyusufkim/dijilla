    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide -mx-4 px-4">
        {companies.map((company, idx) => {
          // Prices not available in real mode yet
          const benzin = "---";
          const motorin = "---";
          const lpg = "---";
              ...
              <CardContent className="p-4 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="text-center p-2 bg-white/5 rounded-lg">
                    ...
                    <p className="text-[11px] font-bold text-white/20">{benzin}</p>
                  </div>
                  <div className="text-center p-2 bg-white/5 rounded-lg">
                    <p className="text-[8px] text-white/40 uppercase mb-1">Motorin</p>
                    <p className="text-[11px] font-bold text-white/20">{motorin}</p>
                  </div>
                  <div className="text-center p-2 bg-white/5 rounded-lg">
                    <p className="text-[8px] text-white/40 uppercase mb-1">LPG</p>
                    <p className="text-[11px] font-bold text-white/20">{lpg}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
