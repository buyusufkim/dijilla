            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-white/5 border border-dashed border-white/10 rounded-xl text-left">
                ...
                <div className="p-8 text-center bg-white/5 rounded-lg border border-white/10">
                  ...
                  <p className="text-sm text-white/40">Resmi veri entegrasyonu aktif değil.</p>
                </div>
              </div>
            </div>
            <Button 
              onClick={onAction}
              disabled={true}
              className="w-full py-6 bg-white/10 text-white/30 font-bold rounded-xl border border-white/10 cursor-not-allowed"
            >
              Borç Sorgula
            </Button>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="p-8 text-center bg-white/5 rounded-2xl border border-dashed border-white/10">
                ...
                <h4 className="text-sm font-bold mb-1">Randevu Sistemi Kapalı</h4>
                <p className="text-xs text-white/40">Şu an için online randevu alınamamaktadır.</p>
              </div>
            </div>
            <Button 
              onClick={onAction}
